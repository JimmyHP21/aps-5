package aps.globalClass.traynotification.notification;

import aps.globalClass.traynotification.animations.*;
import aps.globalClass.traynotification.models.CustomStage;
...
public final class TrayNotification {
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/aps/frontEnd/views/TrayNotification.fxml"));
