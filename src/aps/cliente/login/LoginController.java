...
import aps.cliente.chatwindow.ChatController;
import aps.cliente.chatwindow.Listener;
...
public class LoginController implements Initializable {
    ...
    public void loginButtonAction() throws IOException {
        ...
        FXMLLoader fmxlLoader = new FXMLLoader(getClass().getResource("/aps/frontEnd/views/ChatView.fxml"));
...
//            ResizeHelper.addResizeListener(stage);
            ...
            con.setUsernameLabel(usernameTextfield.getText().toUpperCase());
    ...
    //ESSE METODO E PRA CRIAR UMA ANIMACAO NO LOGIN
